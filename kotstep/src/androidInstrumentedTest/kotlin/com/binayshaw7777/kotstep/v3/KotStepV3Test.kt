...
class KotStepV3Test {
    ...
    fun horizontal_stepIndicatorsExposeExpectedSemantics() {
        ...
        composeTestRule.onNodeWithTag("kotstep_indicator_0", useUnmergedTree = true)
            .assert(hasContentDescription("Step: Account"))
            .assert(hasStateDescription("Completed"))

        composeTestRule.onNodeWithTag("kotstep_indicator_1", useUnmergedTree = true)
            .assert(hasContentDescription("Step: Verify"))
            .assert(hasStateDescription("Current step"))

        composeTestRule.onNodeWithTag("kotstep_indicator_2", useUnmergedTree = true)
    ...
    fun horizontal_collapsingStepPreservesIndicatorAlignment() {
        ...
        val beforeY0 = composeTestRule.onNodeWithTag("kotstep_indicator_0", useUnmergedTree = true).getUnclippedBoundsInRoot().top.value
        val beforeY1 = composeTestRule.onNodeWithTag("kotstep_indicator_1", useUnmergedTree = true).getUnclippedBoundsInRoot().top.value
        assertTrue(abs(beforeY0 - beforeY1) <= 1f)

        composeTestRule.onNodeWithTag("kotstep_step_0", useUnmergedTree = true).performClick()
        ...
        val afterY0 = composeTestRule.onNodeWithTag("kotstep_indicator_0", useUnmergedTree = true).getUnclippedBoundsInRoot().top.value
        val afterY1 = composeTestRule.onNodeWithTag("kotstep_indicator_1", useUnmergedTree = true).getUnclippedBoundsInRoot().top.value
    ...
    fun vertical_collapsingStepPreservesIndicatorAlignment() {
        ...
        val beforeX0 = composeTestRule.onNodeWithTag("kotstep_indicator_0", useUnmergedTree = true).getUnclippedBoundsInRoot().left.value
        val beforeX1 = composeTestRule.onNodeWithTag("kotstep_indicator_1", useUnmergedTree = true).getUnclippedBoundsInRoot().left.value
        ...
        val afterX0 = composeTestRule.onNodeWithTag("kotstep_indicator_0", useUnmergedTree = true).getUnclippedBoundsInRoot().left.value
        val afterX1 = composeTestRule.onNodeWithTag("kotstep_indicator_1", useUnmergedTree = true).getUnclippedBoundsInRoot().left.value
